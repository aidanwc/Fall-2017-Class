...
public class HashTableTester {
    ...
    public static void main(String[] args) {
        ...
        String csvFile = "/Users/Aidan/Downloads/Songs.csv";
       ...
       // System.out.println(songTable.get("Scream"));
       // songTable.put("Scream",new Song("Scream","Jonas Brothers",2012));
        System.out.println();
        //System.out.println(songTable.get("Scream"));
        System.out.println(songTable.size());
        iterator = songTable.iterator();
        while(iterator.hasNext())
        {
            HashNode<String, Song> song;
